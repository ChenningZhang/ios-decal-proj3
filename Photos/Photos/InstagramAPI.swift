        ...
        let task = NSURLSession.sharedSession().dataTaskWithURL(url) {
            ...
            if error == nil {
                ...
                do {
                    ...
                    let photosJSON = feedDictionary.valueForKey("data") as! NSArray
                    for (var i = 0; i < photosJSON.count; i++) {
                        let photoDict: NSDictionary = photosJSON.objectAtIndex(i) as! NSDictionary
                        let currPhoto = Photo.init(data: photoDict) as Photo
